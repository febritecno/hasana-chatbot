...
var diskon = (cape) => {
  ...
  contoh disini adalah class .coupon yaitu identisan yg sama pada seluruh komponen yang mau kita ambil. misal
  ...
  select saja .post jadi xray('url', '.post', [{}])
  
  
  tapi yang sama tiap konten pada area target. sama classnya atau id nya 
  
  oh ya gk usah di urutkan langsung aja pada target. gk usah di urutkan komponen1 2 3 4 dll. langsung saja.
  
  
  
  oh iya, javascript itu all is object , all is array. banyak main data lebih. 1variable '',2array ['',''],3object {satu:'',dua:''}
